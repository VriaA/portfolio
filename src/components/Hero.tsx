    ...
    return (
        <section className="relative z-[2] flex flex-col items-center justify-center h-[100svh] text-off-white pt-28 -mb-20 lg:mb-0">
            ...
            <div className="flex gap-4 md:gap-8 items-center mt-8 md:mt-12 ">
                <a href="#contact" className="py-2 px-4 md:py-3 md:px-8 font-semibold font-satoshi text-base lg:text-[22px] -tracking-[.02em] !leading-none text-black bg-cta-primary rounded-lg">Contact</a>
                <a href="/" className="bold px-0 pb-[1px] font-satoshi text-base lg:text-xl font-regular tracking-[.01em] !leading-none border-b metallic-border">Resume</a>
            </div>
        </section>
    )
}
