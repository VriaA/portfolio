...
export default function Projects({ projects }: { projects: Project[] }): JSX.Element {
    ...
    return (
        <section id="projects" className="relative flex flex-col items-center py-10 md:py-20 z-[2] text-white">
            ...
            {
                !isProjectsPage &&
                <Link to="/projects" className="flex items-center gap-2 mt-10 border-b border-b-white pb-1 font-satoshi font-medium text-lg lg:text-xl text-transparent bg-clip-text bg-cta-primary tracking-[0.01em]"><ShinyText text="See all projects" speed={1} />
                    <svg className="w-5 animate-right" fill="#AEB2FA" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Right arrow icon">
