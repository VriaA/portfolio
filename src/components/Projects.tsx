                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-1 lg:gap-2 w-full mt-5">
                                            {technologiesUsed.map((tech) => {
                                                ...
                                                return (
                                                    <p className="project-stack flex items-center gap-1 w-fit px-2 py-1 xl:px-4 xl:py-2 h-8 xl:h-9 font-satoshi font-medium text-base lg:text-base tracking-[.01em] bg-metallic-text text-transparent bg-clip-text !leading-none rounded-2xl border bg-dark-gray/20 border-white/30 shadow-container">
                                                        {logo}
                                                        {name}
                                                    </p>
                                                )
