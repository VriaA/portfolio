                ...
                <div className="max-w-[900px] mt-[14px] md:mt-10 px-5 md:px-0">
                    {
                        experiences.map((experience, i) => {
                            ...
                            return <div className={`flex flex-col md:flex-row h-fit gap-4 md:gap-0 py-4 md:py-0 ${!isLast ? 'border-b' : ''} md:border-b-0 metallic-border`}>
                                <div className="flex flex-col justify-start w-full md:w-1/2 md:p-4 md:py-6 text-left md:text-right md:border-r metallic-border">
                                    ...
                                    <p className="mt-2 text-base lg:text-lg font-satoshi font-medium !leading-[110%] tracking-[.01em] bg-metallic-text text-transparent bg-clip-text">{institution}</p>
