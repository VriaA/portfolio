...
export default function Contact(): JSX.Element {
    return (
        <section
            ...
            <h3 className="mt-4 md:mt-6 text-center font-brown-sugar text-[32px] md:text-[52px] text-off-white -tracking-[.02em] !leading-transparent">
                Get in touch
            </h3>
            ...
            <form
                ...
                <button className="flex justify-center items-center gap-3 w-full text-lg xl:text-xl mt-5 px-5 py-2 md:py-4 rounded-2xl font-satoshi font-bold bg-cta-primary hover:bg-none hover:bg-[#AEB2FA]">
                    Send message
                    <svg
                        width="17"
                        height="14"
